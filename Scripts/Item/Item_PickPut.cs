...
public sealed class Item_PickPut : MonoBehaviour
{
    ...
    private void Awake()
    {
        m_fadeBox = GameObject.Find("Interaction_PickPutBox_Fade").transform;
    ...
    private IEnumerator PickInit()
    {
        ...
        // 아이템이 고정될 위치
        Vector3 pickItemPosition3D = PlayerManager.Instance.Hand.PickObjectPoint.position;
    ...
    private IEnumerator FixedItem()
    {
        ...
        Transform pickItemPosition = PlayerManager.Instance.Hand.PickObjectPoint;
