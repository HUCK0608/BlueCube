...
public sealed class PlayerBullet2D : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        else if(other.tag != m_playerS && other.tag != m_playerAttackS && other.tag != m_playerSkillS && other.tag != GameLibrary.String_Effect && other.tag != GameLibrary.String_EnemyAttack && other.tag != GameLibrary.String_IgnoreTag)
        {
            m_bullet.EndShoot();
        }
    }
