...
public sealed class PlayerSkill_ChangeView_Old : MonoBehaviour
{
    // 플레이어 매니저
    ...
    // 2D로 변하는 공간 스크립트
    private ChangeViewRect_Old m_changeViewRect_S;
    ...
    private void InitChangeViewRect()
    {
        ...
        m_changeViewRect_S = m_changeViewRect_GO.GetComponent<ChangeViewRect_Old>();
