...
public class Interaction_Push : MonoBehaviour
{
    ...
    [SerializeField]
    private float m_hangDistanceToThis;
    ...
    {
        m_hangPositions = GameLibrary.InitaillizeSameValue(m_hangPositions, 4, transform.position);
    ...
    /// <summary>오브젝트를 잡음</summary>
    public void StartPushLogic()
    {
