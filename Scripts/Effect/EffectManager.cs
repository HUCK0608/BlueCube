...
public enum Effect_Type { Enemy_Boom, Player_Boom, Player_ChangeView_Capsule, Player_Heal, Player_Key, Enemy_Soop_Shoot, Enemy_ChangeView, Player_FootPrint, Key_Landing, Player_Story, FireWorks, Soop }
